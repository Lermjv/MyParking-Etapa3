    ...
    class novaVaga:
        ...
        def achaNovaVaga(vagaID):
            with open('vagas_novas.csv', encoding="utf8") as csv_file:
                ...
                for row in csv_reader:
                    if row[9] == vagaID:
                        return Vaga.novaVaga(row[0],row[1],row[2],row[3],row[4],row[5],row[6], row[7],row[8],row[9],row[10])
        ...
        def adicionaNovaVaga(vagaID):
            ...
            Vaga.criaNovaVaga(novaVaga.locatario, novaVaga.nome, novaVaga.endereço, novaVaga.preço, novaVaga.tipo, novaVaga.latitude, novaVaga.longitude, novaVaga.referencia, novaVaga.adicional)
